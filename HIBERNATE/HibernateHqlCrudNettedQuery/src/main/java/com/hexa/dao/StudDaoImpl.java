...
public class StudDaoImpl implements StudDao {
    ...
    @Override
    public void removeByRollByNameQuery(int rno) {
        Session session = factory.openSession();
        Transaction txt = session.beginTransaction();
        
        Query <Student>Q=session.createNamedQuery("Student.removeByRoll",Student.class);
    ...
    @Override
    public void showDataByNamedQuery() {
        Session session = factory.openSession();
